...
function complete(prefix, count){
    results = [];
    rangelen = 50;
    client.zrank("typeahead", prefix, function(err, start){
	    ...
	    while (results.length != count) {
	        client.zrange("typeahead", start, start+rangelen-1, function(err, data){
	        	console.log(test);
	        	start += rangelen;
		        ...
		        range.forEach(function (item, index, array){
		        		console.log(item);
			        	minlen = min(item.length, prefix.length);
